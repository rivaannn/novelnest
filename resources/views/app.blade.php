    ...
    <div>
        <header class="bg-gray-800" x-data="{ isOpen: false }">
            ...
            <section class="flex items-center justify-center" style="height: 500px;">
                <div class="text-center">
                    ...
                    <h2 class="mt-6 text-3xl font-bold text-white md:text-5xl">Lorem ipsum dolor sit amet, <br>
                        consectetur
                        adipiscing elit</h2>
        ...
        <section class="bg-white">
            <div class="max-w-5xl px-6 py-16 mx-auto">
                ...
                <p class="max-w-lg mt-4 text-gray-600">Duis aute irure dolor in reprehenderit in voluptate velit esse
                    cillum
                ...
                <div class="grid gap-8 mt-10 md:mt-20 md:grid-cols-2">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <div>
                            ...
                            <p class="max-w-lg mt-4 text-gray-600">Vitae nulla euismod velpretium tellus accumsan nulla
                                nunc
                                euismod ve semper. Vitae nulla euismod velpretium tellus
                                accumsan nulla nunc euismod ve semper. Vitae nulla euismod velpretium tellus accumsan
                                nulla nunc
                                euismod ve semper.</p>
                        </div>
                    </div>
        ...
        <section class="bg-white">
            <div class="max-w-5xl px-6 py-16 mx-auto text-center">
                <h2 class="text-3xl font-semibold text-gray-800">Lorem ipsum dolor sit amet, <br> consectetur
                    adipiscing</h2>
                <p class="max-w-lg mx-auto mt-4 text-gray-600">Duis aute irure dolor in reprehenderit in voluptate
                    velit esse
                    cillum
                    dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui
                    officia
