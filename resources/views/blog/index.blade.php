...
@section('content')
    ...
    <form>
        <div class="flex items-center justify-center">
            <div class="w-1/2 p-2 mt-4 rounded-lg">
                <div class="flex">
                    <div
                        class="flex items-center justify-center p-5 bg-white border-r border-gray-200 rounded-tl-lg rounded-bl-lg">
                    ...
                    <input type="text" class="w-full pl-2 text-base font-semibold bg-white outline-0"
                        placeholder="silahkan cari disini...." id="" />
        ...
        <ul class="inline-flex -space-x-px text-sm">
            <li>
                <a href="#" aria-current="page"
                    class="flex items-center justify-center h-8 px-3 leading-tight text-gray-500 bg-white border border-gray-300 ms-0 border-e-0 rounded-s-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Previous</a>
            </li>
            <li>
                <a href="#"
