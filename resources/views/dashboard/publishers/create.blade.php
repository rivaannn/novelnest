                    ...
                    <form action="{{ route('publishers.store') }}" method="POST">
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('publishers.index') }}"
                                class="inline-block px-4 py-2 text-gray-200 bg-gray-500 rounded-md dark:bg-gray-700 me-2 hover:bg-gray-700 focus:outline-none focus:shadow-outline-gray active:bg-gray-700">
                                {{ __('Cancel') }}
                            </a>
                            <button type="submit"
