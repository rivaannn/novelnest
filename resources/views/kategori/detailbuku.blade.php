...
@section('content')
    <a href="{{ url('/kategori') }}" class="ms-auto">
        <button
            class="flex items-start mt-16 ml-56 px-6 py-2 text-white bg-gray-500 border-0 rounded-full focus:outline-none hover:bg-gray-600"><svg
            ...
            <div class="flex flex-wrap mx-auto lg:w-4/5">
                ...
                <div class="w-full lg:w-1/2 lg:pl-10 lg:py-6 lg:mt-0">
                    ...
                    <div class="flex">
                        ...
                        <button
                            class="flex items-end ml-24 px-6 py-2 text-white bg-blue-500 border-0 rounded-full ms-2 focus:outline-none hover:bg-blue-600">Beli
                            Buku </button>
                    </div>
                </div>
            </div>
