...
@section('content')
    ...
    <button
        class="flex items-start px-3 py-2 mt-16 mb-4 ml-56 text-gray-600 bg-gray-300 border-0 rounded-full focus:outline-none hover:bg-gray-200 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-700"><svg
